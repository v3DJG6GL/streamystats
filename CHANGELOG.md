...
## [2.17.0](https://github.com/v3DJG6GL/streamystats/compare/v2.16.0...v2.17.0) (2026-03-02)


### Features

* add "Title Count" aggregation option for people stats ([#399](https://github.com/v3DJG6GL/streamystats/issues/399)) ([dc85d25](https://github.com/v3DJG6GL/streamystats/commit/dc85d250c13f63e13c0221eaf416038bca16cc8c))
* add Asia/Karachi timezone option ([#414](https://github.com/v3DJG6GL/streamystats/issues/414)) ([6fe8791](https://github.com/v3DJG6GL/streamystats/commit/6fe879138f95f063625491d288be231d1db6dbea))
* add backfill endpoint for Jellyfin server IDs and update server data structure in job-server module ([61ae969](https://github.com/v3DJG6GL/streamystats/commit/61ae9690d7c1d7dd7e76aee8c667c5a09331fe2f))
* add Bangladesh Standard Time (Dhaka) to timezone options ([#389](https://github.com/v3DJG6GL/streamystats/issues/389)) ([467bcdc](https://github.com/v3DJG6GL/streamystats/commit/467bcdc0e6f8a9aee120aebd7f369d96dac0f4e8))
* add clickable links to library statistics cards ([1597522](https://github.com/v3DJG6GL/streamystats/commit/159752267eb80d395faedaeaf2f616db09a22d41))
* add external API support for watchlist CRUD operations ([7ee1a40](https://github.com/v3DJG6GL/streamystats/commit/7ee1a40784f92b381d00a2d7b5c4572aeebb00ff))
* add format and format:fix scripts for nextjs-app and update lint:fix command for safety ([f940d24](https://github.com/v3DJG6GL/streamystats/commit/f940d24083863df85b6f4563a8647107667119a3))
* add image proxy API for fetching Jellyfin images with server authentication ([79eb12d](https://github.com/v3DJG6GL/streamystats/commit/79eb12d7bfd2cdf1ff63c80ded4274d57046138c))
* add Jellyfin QuickConnect settings link to login form ([213fb32](https://github.com/v3DJG6GL/streamystats/commit/213fb32625a8085f677bac0821e7d2d3329f8e14))
* add jellyfinId to servers and isPromoted to watchlists ([892906f](https://github.com/v3DJG6GL/streamystats/commit/892906fd410b1aae54010bcdf87fa4e46281f48e))
* add new API endpoints for recommendations and watchlists, including server identification and query parameters ([7cbfbce](https://github.com/v3DJG6GL/streamystats/commit/7cbfbce86e224f070d376799b1e1ca1bf6be2443))
* add OCI source label to Docker images for Renovatebot support ([73dd6ef](https://github.com/v3DJG6GL/streamystats/commit/73dd6ef2242ca32287eb75e29680448eff679cd5)), closes [#276](https://github.com/v3DJG6GL/streamystats/issues/276)
* add pause/resume logging with debouncing to prevent flickering ([ddcb786](https://github.com/v3DJG6GL/streamystats/commit/ddcb7864f89b7fcd68aba61a742468c25ea1db96))
* add per-server configurable job schedules ([744ab27](https://github.com/v3DJG6GL/streamystats/commit/744ab275f564f94527b2437529eb88d663fef0e6))
* add per-server timezone support ([63e0dc8](https://github.com/v3DJG6GL/streamystats/commit/63e0dc8e0b8ac956e66a4d7f1800a6e1fb3c1084))
* add promoted watchlists and external API improvements ([a61ec2c](https://github.com/v3DJG6GL/streamystats/commit/a61ec2cca8cb3de561d7f920793bb266db4024a0))
* add quickconnect authentication ([8eb2e52](https://github.com/v3DJG6GL/streamystats/commit/8eb2e527cb4b6419c557f6387f2b20b5cdf2eb59))
* add quickconnect authentication ([db8cc35](https://github.com/v3DJG6GL/streamystats/commit/db8cc35bb3115b6a585591212311a5ff8f18c7c7))
* Add session poller resilience and monitoring ([2a2dcdc](https://github.com/v3DJG6GL/streamystats/commit/2a2dcdcfec1b073f8215d52605b7eddf0b2f96ef))
* add shared rate-limiter module ([2ae5b9a](https://github.com/v3DJG6GL/streamystats/commit/2ae5b9aac0070aa06138a1633408c2dbb165a00f))
* add SKIP_STARTUP_FULL_SYNC environment variable to skip full sync on server startup ([4db4772](https://github.com/v3DJG6GL/streamystats/commit/4db477228798507a87652bdc5b42ecc99cc9ca11))
* add typechecking scripts and CI workflow ([c49cb69](https://github.com/v3DJG6GL/streamystats/commit/c49cb696f8b4162489dac8cc752518d1a384cda4))
* add user sub-page handling and admin permission checks for security paths ([0d63d71](https://github.com/v3DJG6GL/streamystats/commit/0d63d719c9dcde0303960b36f05719d4b599d53c))
* add vaul dependency and implement Drawer component for improved UI in ChatDialog ([74c3c9c](https://github.com/v3DJG6GL/streamystats/commit/74c3c9c754aa5d5a659aa6114ba59e98e975a3ed))
* add wrapped design ([#345](https://github.com/v3DJG6GL/streamystats/issues/345)) ([c1b053d](https://github.com/v3DJG6GL/streamystats/commit/c1b053d635e78efee23ba77eb2d5f825e4342dba))
* aio image and container ([b24da5e](https://github.com/v3DJG6GL/streamystats/commit/b24da5e0dfe0c5a2fc586315157e01e2cfa1a90f))
* almost done watching heatmap for user page (and me page) ([227998b](https://github.com/v3DJG6GL/streamystats/commit/227998bb9ba5db2052b0e242438e8f60e7c9dd19))
* **api:** add cors headers to recommendations endpoint ([f4ed35c](https://github.com/v3DJG6GL/streamystats/commit/f4ed35c6d4a669d70c0a1bd7ce22630ed280bd08))
* auto-expire quick-connect polling after 5 minutes ([61badf5](https://github.com/v3DJG6GL/streamystats/commit/61badf54c18e1d8ab2afcc4dce0533f66d6e17d5))
* better history filters ([37972e9](https://github.com/v3DJG6GL/streamystats/commit/37972e9f06b1e889355ab9d0e8d8ee3aed75110e))
* bun test job in pr builds ([9013145](https://github.com/v3DJG6GL/streamystats/commit/9013145c4fbc32d14270b5d35c05680c43adc529))
* client stats ([e4db0de](https://github.com/v3DJG6GL/streamystats/commit/e4db0de0894f9cc224ec400ae903d0da2aea7f28))
* colors ([3e3ad21](https://github.com/v3DJG6GL/streamystats/commit/3e3ad2150c5f2d47faea49ecbbd893f0403a890b))
* disable password-based login ([464de79](https://github.com/v3DJG6GL/streamystats/commit/464de79c8d62419f5d4dc5ea9a673d1465a348cf))
* disable password-based login ([60b6dce](https://github.com/v3DJG6GL/streamystats/commit/60b6dce2611328559abc5ca813a9623f8a1e5229))
* **docs:** aio instructions ([d5215ff](https://github.com/v3DJG6GL/streamystats/commit/d5215fffe430ac22ab2fe5c718736a5f59b0b9ae))
* dropdown actions in watchlist table ([7678d69](https://github.com/v3DJG6GL/streamystats/commit/7678d697af112bd5373d5e052250564422703147))
* enhance ActivityLogTable with user and activity type filters ([c60786a](https://github.com/v3DJG6GL/streamystats/commit/c60786a35678e2f31efa8e9bd9ab0bdb84a44882))
* enhance error handling and logging in embedding jobs ([b63894f](https://github.com/v3DJG6GL/streamystats/commit/b63894fe622dff94943c4e7c75c11907a03608ae))
* enhance ErrorBoundary with detailed error display and reporting options ([5682bfc](https://github.com/v3DJG6GL/streamystats/commit/5682bfcbecd50ba858fdaf0d62d25dcf0edc11cc))
* enhance text preparation for item embeddings with structured metadata and improved people data handling ([822840d](https://github.com/v3DJG6GL/streamystats/commit/822840de52812e7adfea17bc426e4d09048bbed4))
* export new backfill job and constants from server-jobs module ([d38c43d](https://github.com/v3DJG6GL/streamystats/commit/d38c43d050ea49c57101b97e451a83b49b1c16a6))
* global search ([31a4f21](https://github.com/v3DJG6GL/streamystats/commit/31a4f21063bdd9eae90c1d58f17d6e78f35fcbe4))
* global search ([d06c631](https://github.com/v3DJG6GL/streamystats/commit/d06c631f71a226e977e27a0082b4569d1a4140a3))
* global watchtime page date picker ([1c09ffc](https://github.com/v3DJG6GL/streamystats/commit/1c09ffc2ae09df8db7588e95c2e7aade02c76e0c))
* implement backfill job for Jellyfin IDs and enhance server data handling in job-server module ([36feea9](https://github.com/v3DJG6GL/streamystats/commit/36feea95f73acd1d18294fb4cc77aa05ea584f62))
* implement Jellyfin ID backfill trigger in SyncScheduler for servers without IDs ([f6a8638](https://github.com/v3DJG6GL/streamystats/commit/f6a863855fa6e8c50791639e7facc8d59df1100c))
* implement loading skeleton for login page and refactor component structure ([15904eb](https://github.com/v3DJG6GL/streamystats/commit/15904eb4a5fc4567627cfb461120c866388abe97))
* implement security dashboard layout and components ([c17c531](https://github.com/v3DJG6GL/streamystats/commit/c17c5312f7afe01202b5307fb7773e8afd25c54d))
* implement WatchlistsGrid component for displaying and managing user watchlists ([dccd851](https://github.com/v3DJG6GL/streamystats/commit/dccd85138feb8d11b0542c213543fe26158a9269))
* inf scroll for recommendations ([07b94d2](https://github.com/v3DJG6GL/streamystats/commit/07b94d28657351df571f97607f6aa8f40c119cce))
* inf scrolling for season recommendations ([c566994](https://github.com/v3DJG6GL/streamystats/commit/c566994412e444e5414927b3d92c97b4e7b6d024))
* infer sessions based on items marked as played ([4f67f28](https://github.com/v3DJG6GL/streamystats/commit/4f67f28cf76f30e61a102c1e7d0ed6ebdfa9fdde))
* infer sessions based on items marked as played ([fbb5f9e](https://github.com/v3DJG6GL/streamystats/commit/fbb5f9ef6ff6c70ddb363695a054ef116ab7dd8f))
* internal external url ([#335](https://github.com/v3DJG6GL/streamystats/issues/335)) ([bf414e8](https://github.com/v3DJG6GL/streamystats/commit/bf414e8423d95763399936b62ae1c7222de6cbb0))
* **job-server:** make cron schedules configurable via env vars ([3edef46](https://github.com/v3DJG6GL/streamystats/commit/3edef46f4f164bb36c4cbefc8ab8a48bee2d0750))
* library stats ([ee7accb](https://github.com/v3DJG6GL/streamystats/commit/ee7accb7f420b6b57490f39cb534f1b7244c0fa3))
* mark items as played and infer the watchtime ([a226f65](https://github.com/v3DJG6GL/streamystats/commit/a226f65f930fe35f4e447ef1eec57855a94593b1))
* more detection rules ([1d27511](https://github.com/v3DJG6GL/streamystats/commit/1d27511c926f6544867e15e6f3bfc32024ce381f))
* more watch stats ([f4653fc](https://github.com/v3DJG6GL/streamystats/commit/f4653fc24660e726083c27a5436f6c49f85e8046))
* people statistics ([de1c2a1](https://github.com/v3DJG6GL/streamystats/commit/de1c2a1e34c75d3cbf7b302b46ec6bbd4ce3c6b7))
* people stats ([ece9d38](https://github.com/v3DJG6GL/streamystats/commit/ece9d3858767a33f4eca66a0245aa6e65ed07ec9))
* rate-limit password login attempts per server ([a2a3831](https://github.com/v3DJG6GL/streamystats/commit/a2a383163db16e9c8bdae481665745457e40b835))
* rate-limit quick-connect initiation ([47c2344](https://github.com/v3DJG6GL/streamystats/commit/47c2344c188802234222503531072a7539f35e71))
* recently added ([7910655](https://github.com/v3DJG6GL/streamystats/commit/7910655e6d59e01fd01e085954c05aa67e9249c3))
* recently added ([aff71d2](https://github.com/v3DJG6GL/streamystats/commit/aff71d26d2afd0e64c677490e765efb2004a90bc))
* recently added items on dashboard ([f826228](https://github.com/v3DJG6GL/streamystats/commit/f826228eca30f01539884323a09417ffe2da3e32))
* **recommendations:** add series recommendations support ([32c660a](https://github.com/v3DJG6GL/streamystats/commit/32c660a2e948694b05851af35132571f65bf124a))
* refresh button ([c4ca818](https://github.com/v3DJG6GL/streamystats/commit/c4ca818e76cfb91171b24e492ce1e49181aea0bb))
* register backfill job for Jellyfin IDs in job queue ([3d6a787](https://github.com/v3DJG6GL/streamystats/commit/3d6a7876953ca44ea5b6e6758df9540f766f8e55))
* route to user security page ([a443c7a](https://github.com/v3DJG6GL/streamystats/commit/a443c7a72ead741f5e4f198bf668136521dab10e))
* seasonal recomendations ([e839603](https://github.com/v3DJG6GL/streamystats/commit/e8396038a0d5acb78387e1f302436406033fb7df))
* see what user you share taste with ([c123290](https://github.com/v3DJG6GL/streamystats/commit/c1232905e91c4bb9fba8a8893b946134e5da3deb))
* show people sync in settings ([9327a5c](https://github.com/v3DJG6GL/streamystats/commit/9327a5ce454df94d44cd98abbc12e4952adfb2ba))
* show people sync progress in settings ([c762e04](https://github.com/v3DJG6GL/streamystats/commit/c762e041b80bcaf0280902277ded2166f781d570))
* show user list on pin ([961ad67](https://github.com/v3DJG6GL/streamystats/commit/961ad67753e7d24b32d3028409c4958777b4143d))
* **tests:** implement some tests for watchlists api ([5ce7344](https://github.com/v3DJG6GL/streamystats/commit/5ce7344e0867d4066efd938aa701eaa102e379bc))
* **ui:** improve user genre radar chart readability ([#412](https://github.com/v3DJG6GL/streamystats/issues/412)) ([ea62991](https://github.com/v3DJG6GL/streamystats/commit/ea62991b17fdf5e9f74c8324e67020373c6dd2cb))
* use cache  components ([a79867f](https://github.com/v3DJG6GL/streamystats/commit/a79867f8f98256b5ad13b55dcb305c8230c36050))
* use top items on user page ([448e175](https://github.com/v3DJG6GL/streamystats/commit/448e175e4941c79070fe04146c57100a07da8a22))
* user fingerprinting for security and determining shared accounts ([52adda9](https://github.com/v3DJG6GL/streamystats/commit/52adda93439bb01515c14a4d4a015b1fe58dd25e))
* watchlists ([7df353d](https://github.com/v3DJG6GL/streamystats/commit/7df353de7b97166f507177a4adbdae8c6d8e10fc))
* **watchlists:** add MediaBrowser auth support and sanitize searchVector from responses ([a0962df](https://github.com/v3DJG6GL/streamystats/commit/a0962df7ffff220dcfca4089c4e46cf2ea0809cf))


### Bug Fixes

* **#347:** useQueryParams should strip basePath from pathname ([ee1e337](https://github.com/v3DJG6GL/streamystats/commit/ee1e3377bf5ba08a1b867d1ea823e1f46c335ac2))
* actors breadcrumbs ([55cb29e](https://github.com/v3DJG6GL/streamystats/commit/55cb29eb3f79aa60974e2647731989e97fca19d3))
* add auth to unprotected API routes and remove dead image-proxy endpoint ([#427](https://github.com/v3DJG6GL/streamystats/issues/427)) ([de404ad](https://github.com/v3DJG6GL/streamystats/commit/de404ad220226b8cbb75dba9b79361e51dc08bc0))
* add authentication to people-sync-progress endpoint ([14650da](https://github.com/v3DJG6GL/streamystats/commit/14650daecffbba78b565463d71661509309d8bc9))
* add indexes for better performance ([4232cf7](https://github.com/v3DJG6GL/streamystats/commit/4232cf7ce9160e693474a2d37fe6d6deea268a52))
* add job-server health check condition in docker-compose ([76a97d1](https://github.com/v3DJG6GL/streamystats/commit/76a97d1a8043f0752a1d5c28d983fa19028ece12))
* add map key to solve Map reused bug ([116c70f](https://github.com/v3DJG6GL/streamystats/commit/116c70f990aacbd9bf7b0d98a5963f5615d82df4))
* add mapKey prop to solve Map reused bug ([ab67027](https://github.com/v3DJG6GL/streamystats/commit/ab670277f1dc3fc7b11f8a64c55ceca9a3e8adcc))
* add prop map key to solve map reused bug ([54c420c](https://github.com/v3DJG6GL/streamystats/commit/54c420cbbaa7ef2f131bd33b8aa7c74d7274e1b3))
* add security middleware and input validation to Next.js app ([#425](https://github.com/v3DJG6GL/streamystats/issues/425)) ([18f3b72](https://github.com/v3DJG6GL/streamystats/commit/18f3b72095fe1a837dbc10304703275a20475325))
* add voyage as distinct embedding provider to fix API parameter mismatch ([#420](https://github.com/v3DJG6GL/streamystats/issues/420)) ([#446](https://github.com/v3DJG6GL/streamystats/issues/446)) ([5b46469](https://github.com/v3DJG6GL/streamystats/commit/5b464691023689bd28b14de78e86309a1cf3f1be))
* Added X-Emby-Authorization header (MediaBrowser Client="StreamyStats", ...) to all four QuickConnect Jellyfin API calls in jellyfin-auth.ts ([dbee5f1](https://github.com/v3DJG6GL/streamystats/commit/dbee5f1637bd8cda097c782e65b166d923e77bd6))
* Added X-Emby-Authorization header (MediaBrowser Client="StreamyStats", ...) to all four QuickConnect Jellyfin API calls in jellyfin-auth.ts ([8180699](https://github.com/v3DJG6GL/streamystats/commit/81806990be3e3a2fb0af822dc3f079ebfd87ac22))
* address security audit findings for Docker and Next.js self-hosting ([7a2e336](https://github.com/v3DJG6GL/streamystats/commit/7a2e3369221dcfb965bcf9bc632432efa60f8c73))
* adjust margin for UserSimilarity component in user page ([f9369c8](https://github.com/v3DJG6GL/streamystats/commit/f9369c893e15bdfc6562675ebc94b312946b034c))
* aio container build ([17fcc73](https://github.com/v3DJG6GL/streamystats/commit/17fcc7318237f31700f6efb93ff58d6ef08e25ea))
* allow password login fallback when QuickConnect is disabled ([9bfcd60](https://github.com/v3DJG6GL/streamystats/commit/9bfcd60be8618a3847e31ebb90b075cf3bf50afe))
* allow server creation without session auth ([#429](https://github.com/v3DJG6GL/streamystats/issues/429)) ([bb04813](https://github.com/v3DJG6GL/streamystats/commit/bb04813fd751c1f562e629cb17dde16233ff8361))
* always join items table in per-user queries to prevent inconsistent results when toggling exclusions (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([38be8b5](https://github.com/v3DJG6GL/streamystats/commit/38be8b59d5f75eac0e5a7385f59ab58923db589b))
* always join items table in per-user queries to prevent inconsistent results when toggling exclusions (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([1673a52](https://github.com/v3DJG6GL/streamystats/commit/1673a52d14760f8ec63faf630e1f6c9c6131e72a))
* apply library exclusion during session aggregation instead of post-filtering (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([3b4e6ea](https://github.com/v3DJG6GL/streamystats/commit/3b4e6eacf127a22645dd05828e6f2d1bb830eb06))
* apply library exclusion during session aggregation instead of post-filtering (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([53350b6](https://github.com/v3DJG6GL/streamystats/commit/53350b6f3004d3f949778b28e24440c62c5b2285))
* apply stricter rate limits for unknown IP addresses ([a94545c](https://github.com/v3DJG6GL/streamystats/commit/a94545cac258b9c4c15a85c32f21cc79dc241d9a))
* better design ([79e9387](https://github.com/v3DJG6GL/streamystats/commit/79e938729fa0b3153d69a18468e5392a8f524820))
* better error page ([3cad946](https://github.com/v3DJG6GL/streamystats/commit/3cad946cd04eaf936e24ec5c1fa7f9beabf50aed))
* breadcrumbs for watchtime page ([c3847b4](https://github.com/v3DJG6GL/streamystats/commit/c3847b4c5c230f686de6c6ce89d80f1051dd21ab))
* build error ([96aae63](https://github.com/v3DJG6GL/streamystats/commit/96aae63573b9c827c9d12683f56a634f34ca4850))
* build error ([4bf6334](https://github.com/v3DJG6GL/streamystats/commit/4bf63341a3c33e30f41463f366cea9f54ed0e69d))
* build error ([7ba7da4](https://github.com/v3DJG6GL/streamystats/commit/7ba7da4d3d51158d862ae604889dd0f9831cc871))
* build error ([caee7f3](https://github.com/v3DJG6GL/streamystats/commit/caee7f3d17445f8dac3e3a5e686026c562f173f4))
* build error ([9fee75a](https://github.com/v3DJG6GL/streamystats/commit/9fee75a9e1fb7a8656ca75d708d9e807cdc0d8a5))
* build issue ([1f46881](https://github.com/v3DJG6GL/streamystats/commit/1f468815a6eea1ba1819078db5a019730094bf06))
* build issue ([ff0ced6](https://github.com/v3DJG6GL/streamystats/commit/ff0ced6ffb7f8ceef054d4f4e107e79f2bfed0a6))
* build issue ([b5fd8ea](https://github.com/v3DJG6GL/streamystats/commit/b5fd8ea1470b325f77558bcbb64ba6cb9bfbb030))
* bypass Next.js image optimization for Jellyfin images to resolve private IP blocking ([e0c4024](https://github.com/v3DJG6GL/streamystats/commit/e0c402465c31973a79aae6b5ef1eca1efa235fcf))
* cache + remove arm from pr images ([cd49939](https://github.com/v3DJG6GL/streamystats/commit/cd49939ea240b534601b17af073eb017462b40fa))
* cache data ([c4cfee6](https://github.com/v3DJG6GL/streamystats/commit/c4cfee698c0a000a587bda5e080bd44f4fdcf23a))
* cap in-memory rate limiter maps to prevent unbounded growth ([be5824e](https://github.com/v3DJG6GL/streamystats/commit/be5824e68671be19b677c494c3f351b95fcd70e4))
* change to linegraph ([def8229](https://github.com/v3DJG6GL/streamystats/commit/def822964969c13b58d59a8e61b47d3ec7dc14a3))
* Client name regression ([ecebb03](https://github.com/v3DJG6GL/streamystats/commit/ecebb0345beeb7d018e72d517537a756a0ea5fa6))
* combine genres in spider graph fixes [#346](https://github.com/v3DJG6GL/streamystats/issues/346) ([be0f0dc](https://github.com/v3DJG6GL/streamystats/commit/be0f0dc6f4be66938f25d50c1146b9855663b0f4))
* complete jellyfinHeaders migration in checkQuickConnectStatus and authenticateWithQuickConnect ([5e3a78c](https://github.com/v3DJG6GL/streamystats/commit/5e3a78c29bb04f22fb808cbe86e33a7fff4cf77e))
* connection issues ([12a0ba6](https://github.com/v3DJG6GL/streamystats/commit/12a0ba6a3edd04e78f507d2ee6d03219b4de53a2))
* copy geo files to expected location ([bbdf17d](https://github.com/v3DJG6GL/streamystats/commit/bbdf17d1b32b1d33cce73d7e99944de421de912d))
* copy real nextjs-app package.json in job-server and migration Dockerfiles ([c119c5f](https://github.com/v3DJG6GL/streamystats/commit/c119c5f901c64706eaf4f10360c633801324ea38))
* correct issue URL formatting in global error handling ([b241b67](https://github.com/v3DJG6GL/streamystats/commit/b241b678a3b540a8ebc4e54797cd89fa85c5acc5))
* correct migration 0041 ordering so internal_url column is applied ([bd6150c](https://github.com/v3DJG6GL/streamystats/commit/bd6150c1ad17c80414577e47254a3466c945bff2))
* correct QuickConnect secret regex to match Jellyfin's 64-char hex format ([cdd03fe](https://github.com/v3DJG6GL/streamystats/commit/cdd03fe8461472c33a894696bb2cb7aac8517af9))
* correct watch time duration formatting in charts ([#390](https://github.com/v3DJG6GL/streamystats/issues/390)) ([79e28f1](https://github.com/v3DJG6GL/streamystats/commit/79e28f130911d501a581936239c8523ed6211dc5))
* date filter ([57e9df3](https://github.com/v3DJG6GL/streamystats/commit/57e9df338eb472fc40729768bfee210b2d2fcf10))
* deduplicate media source records in batch insert to prevent duplicate key errors ([aa6b113](https://github.com/v3DJG6GL/streamystats/commit/aa6b113d91303900da90303ae75344f75f7174e0))
* deduplicate media source records in batch insert to prevent duplicate key errors ([b14224b](https://github.com/v3DJG6GL/streamystats/commit/b14224b6b739d38dd273c989846ae45ecd8a46cc))
* deduplicate recommendations by item ID in user-specific recommendations ([8b5f573](https://github.com/v3DJG6GL/streamystats/commit/8b5f573b42931d269a658f607e193948a5cfa78c))
* design ([1359c02](https://github.com/v3DJG6GL/streamystats/commit/1359c02239ff858cd61a76c27a773a04c8aada88))
* design and load improvements ([a2fdead](https://github.com/v3DJG6GL/streamystats/commit/a2fdeadc6291a90bb21c26a4ac40abe981e9faa1))
* **design:** rename chat ai and fix hover effect ([1937baa](https://github.com/v3DJG6GL/streamystats/commit/1937baa3731bb6a0aeb756665af3414676d616e5))
* **design:** toltip clipping card ([734f8a9](https://github.com/v3DJG6GL/streamystats/commit/734f8a96d7ff6d9caec8fc70bf3a467647e6607d))
* don't log checkpoints ([ca09b1c](https://github.com/v3DJG6GL/streamystats/commit/ca09b1cf7e95b0ec590cf9612450a8da7b72db49))
* don't require API key for openai api compatible models ([2a94328](https://github.com/v3DJG6GL/streamystats/commit/2a943284fd58bda9d0d567137bb33e6d5925d247))
* don't show recommended sections if no embeddings ([4e96669](https://github.com/v3DJG6GL/streamystats/commit/4e966691e4c1775583904afd3b12bced15d18163))
* drop unnecessary getServerWithSecrets from login page ([7a25e87](https://github.com/v3DJG6GL/streamystats/commit/7a25e87b35d1290c4fa1d51c2c44671926c8eeff))
* duplicate fingerprint cleanup and improvement ([f975ab1](https://github.com/v3DJG6GL/streamystats/commit/f975ab180aae7979344c36bab340a90a4eec8d13))
* dynamically compute Lunar New Year zodiac animal ([#413](https://github.com/v3DJG6GL/streamystats/issues/413)) ([f1c5ab6](https://github.com/v3DJG6GL/streamystats/commit/f1c5ab618c0a4e6db697e9d113e2e11d5b64d80f))
* enforce disablePasswordLogin server-side in login action ([aa0d14b](https://github.com/v3DJG6GL/streamystats/commit/aa0d14b22f764431f5a2fd4372d092031814fcba))
* ensure error handling only sends error messages when they are instances of Error ([5542eb6](https://github.com/v3DJG6GL/streamystats/commit/5542eb664f4c398f79370db612ec94a396b1cdd6))
* error ([e638b2c](https://github.com/v3DJG6GL/streamystats/commit/e638b2cf6c9b522509b0f10ec3e2e49e2332cfeb))
* failing test ([6978476](https://github.com/v3DJG6GL/streamystats/commit/6978476531de0b02260c01ac01fdb9a7c1277e64))
* fetch embedding config from DB for scheduled jobs ([#438](https://github.com/v3DJG6GL/streamystats/issues/438)) ([8e72944](https://github.com/v3DJG6GL/streamystats/commit/8e729442f41dcaa428c76a0657a7625f97af92b1))
* fetch embedding config from DB for scheduled jobs ([#438](https://github.com/v3DJG6GL/streamystats/issues/438)) ([86becd5](https://github.com/v3DJG6GL/streamystats/commit/86becd5b5592affe5471491578f5813745086dd6))
* fetch MediaSources from Jellyfin and sync for existing items ([a194e16](https://github.com/v3DJG6GL/streamystats/commit/a194e169dedb78ad61d2b5379629df96d949c1d4))
* fetching outside of suspense ([b18ad26](https://github.com/v3DJG6GL/streamystats/commit/b18ad26eda58d6e322ef54e11344504a96caf7a8))
* filter deleted items in Almost Done to prevent duplicate episodes ([#441](https://github.com/v3DJG6GL/streamystats/issues/441)) ([f74efe3](https://github.com/v3DJG6GL/streamystats/commit/f74efe376a65a5fbf9ffdee6ee2a537e0ba1ac31))
* for aio container ([55ec986](https://github.com/v3DJG6GL/streamystats/commit/55ec986df09ce9acbd0fe2c4906f90103bac20f6))
* guard against overlapping QuickConnect poll completion callbacks ([604910c](https://github.com/v3DJG6GL/streamystats/commit/604910c9e25610f1d6373308915bcd1f3f5e54bd))
* handle malformed JSON in quick-connect status endpoint ([1f81381](https://github.com/v3DJG6GL/streamystats/commit/1f81381ca0c95c85ca787bc3cf70bf3ddc9e8470))
* handle malformed JSON in quick-connect status endpoint ([567f07b](https://github.com/v3DJG6GL/streamystats/commit/567f07ba965dcab9864ae4e9345dba6c75a76ab6))
* harden quick-connect status endpoint against enumeration ([95cc8c0](https://github.com/v3DJG6GL/streamystats/commit/95cc8c0e179307d75cef1117e7cbe90183d66295))
* healthcheck in dockerfiles ([7d10ac7](https://github.com/v3DJG6GL/streamystats/commit/7d10ac7ae83b03854d97e96f8353af26ab65f77b))
* hide last played user from non-admin users on library page ([#415](https://github.com/v3DJG6GL/streamystats/issues/415)) ([375fcc3](https://github.com/v3DJG6GL/streamystats/commit/375fcc3222b10074f91ce86d3fbd29c408b91d9f))
* history table filters on user profile page ([169d0cb](https://github.com/v3DJG6GL/streamystats/commit/169d0cb0eb1f9af0cca1b301a2acc9cd311fb579))
* hydration issue ([9f1643e](https://github.com/v3DJG6GL/streamystats/commit/9f1643ef18e16912e3ee8ca427636ba1e7c0f7be))
* idempotent migration ([3465228](https://github.com/v3DJG6GL/streamystats/commit/346522826c50f96f097f56c0b8edc43bb11022bc))
* ignore mcp file ([ffd762f](https://github.com/v3DJG6GL/streamystats/commit/ffd762f9c8e7115f5307c3398bf15c96c5e6dcad))
* **images:** allow local IPs unconditionally to fix private Jellyfin servers ([f55c345](https://github.com/v3DJG6GL/streamystats/commit/f55c345b375ce3d15cc2eca561bdfdc23e518b37))
* implement conditional startup full sync based on SKIP_STARTUP_FULL_SYNC environment variable ([4e03ea7](https://github.com/v3DJG6GL/streamystats/commit/4e03ea7d36cd8c1cba3fab1956c6612671e32ef2))
* improve ai streaming chat response and tool listing ([7d4bba1](https://github.com/v3DJG6GL/streamystats/commit/7d4bba1f21effacda96e221345e4c2c8a0241f09))
* improve loading ([bfe544a](https://github.com/v3DJG6GL/streamystats/commit/bfe544ab52d8676b91692758bb99304d78afca60))
* improve mobile design ([f1409f8](https://github.com/v3DJG6GL/streamystats/commit/f1409f88553865adcd1dbb2e25105281ecf706f6))
* improve session poller reliability with retries and better error logging ([0912f63](https://github.com/v3DJG6GL/streamystats/commit/0912f638adfba5e20a403908707e9491fd172774))
* improve type safety for image field comparisons in hasImageFieldsChanged function ([255b313](https://github.com/v3DJG6GL/streamystats/commit/255b313a597018abd398d14601fa1d54314ca99a))
* improved api key saving ([51638a2](https://github.com/v3DJG6GL/streamystats/commit/51638a24c316db43dee3fb53811f472f2df6fc36))
* instructions ([c31652a](https://github.com/v3DJG6GL/streamystats/commit/c31652a0a3de35a239610e4df73f428137069519))
* internal_url migration (errorMissingColumn) ([27154dc](https://github.com/v3DJG6GL/streamystats/commit/27154dcf94d3dac8939dfab255352b1ecae2265a))
* **jellyfin:** ensure isFolder defaults to false ([4fdeaea](https://github.com/v3DJG6GL/streamystats/commit/4fdeaea22497ab86a926ca0f5b6a60186b556a32))
* keep tab i query param ([9955ae6](https://github.com/v3DJG6GL/streamystats/commit/9955ae6e32d898e6c6f6d6083ab46603e61e34f2))
* key login rate limiters by IP to prevent cross-user DoS ([5cd2990](https://github.com/v3DJG6GL/streamystats/commit/5cd29901c6a259f8017f79bb881dd0c4bd9bc182))
* less agressive activities sync ([0746292](https://github.com/v3DJG6GL/streamystats/commit/0746292edfae8fde52456f4555d5b2a2b65c081d))
* less data pulled from jellyfin ([533113f](https://github.com/v3DJG6GL/streamystats/commit/533113f08737b13f5e662a663b258536a20a0d71))
* lint ([af6856e](https://github.com/v3DJG6GL/streamystats/commit/af6856e6f68fa6d4bf80cc36596ad76627ba635d))
* lint ([5e656e9](https://github.com/v3DJG6GL/streamystats/commit/5e656e9ce292d8ef98a2af7b983245be13568200))
* lock bun version ([65fdeee](https://github.com/v3DJG6GL/streamystats/commit/65fdeee5f5befbc53375bd8b99882cefe5019461))
* logs ([61bc665](https://github.com/v3DJG6GL/streamystats/commit/61bc665f456b6b6b7c86c50a2bd31b8dfbecfab5))
* make library exclusions safe for items without item_libraries entries (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([a35a415](https://github.com/v3DJG6GL/streamystats/commit/a35a415199f54183c6b76c7f3e9cae1337166bf0))
* make library exclusions safe for items without item_libraries entries (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([0daefdf](https://github.com/v3DJG6GL/streamystats/commit/0daefdf1a6dcbb82102da881cdef8b29db9bd65f))
* mark all as resolved ([7c2ab4f](https://github.com/v3DJG6GL/streamystats/commit/7c2ab4f01dad9a5f62d0ecb2410768080f92c044))
* mark items as synced manually instead of relying on people existing ([2892bb2](https://github.com/v3DJG6GL/streamystats/commit/2892bb2c76147d05b06f4c4f78ed8330cf50c74e))
* migrate all exclusion queries to use item_libraries junction table (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([0ef08bd](https://github.com/v3DJG6GL/streamystats/commit/0ef08bda8fd8ea126337f13ad12db9929fbe47e8))
* migrate all exclusion queries to use item_libraries junction table (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([be00cc9](https://github.com/v3DJG6GL/streamystats/commit/be00cc982f9abe63aed9195fb747903dcf713c6c))
* migrate Jellyfin API calls to MediaBrowser auth header ([#447](https://github.com/v3DJG6GL/streamystats/issues/447)) ([d041f47](https://github.com/v3DJG6GL/streamystats/commit/d041f474760c7f200295160267bd79d0537a2626))
* missed commit for pr 446 ([b44956b](https://github.com/v3DJG6GL/streamystats/commit/b44956bfc5ef88b6cc46e4396f1f7025650e29e9))
* missing geoip file ([2fca30a](https://github.com/v3DJG6GL/streamystats/commit/2fca30abd79ad78fe7521337a55fa614d62b8c11))
* Missing registry prefix/Uppercase username ([bdf1c7a](https://github.com/v3DJG6GL/streamystats/commit/bdf1c7a0c31c3cdc7162e2238708a6cd9578c449))
* move deleted item migration after upsert to satisfy FK constraints (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([8c3735a](https://github.com/v3DJG6GL/streamystats/commit/8c3735a16a146e422d0a81a87f12701bd4428744))
* move deleted item migration after upsert to satisfy FK constraints (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([af39bd0](https://github.com/v3DJG6GL/streamystats/commit/af39bd08fb692f11eb0000308621f4799c207a10))
* move params await inside Suspense to avoid blocking route ([0ef9cef](https://github.com/v3DJG6GL/streamystats/commit/0ef9cefa7de54918ef5a8c8f98628a5a925c387d))
* ollama connection issue ([e40c11b](https://github.com/v3DJG6GL/streamystats/commit/e40c11bcb32f6f825aa14b45026c4e70bd9006b4))
* only for admin ([e2b7d5b](https://github.com/v3DJG6GL/streamystats/commit/e2b7d5b04fd4120d15760fc7ed0c983a6a5e592e))
* only include items actually watched ([37b89d7](https://github.com/v3DJG6GL/streamystats/commit/37b89d7ea22a2aad1149df1aa1c3ab212b49d011))
* pass serverUrl to standalone QuickConnectForm ([22d6aa4](https://github.com/v3DJG6GL/streamystats/commit/22d6aa4430babaf73817e53fbc4c0bda75689209))
* populate item_libraries for unchanged items during sync (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([2277404](https://github.com/v3DJG6GL/streamystats/commit/227740431f0d7fc839e8ccf9e1f802d819d843b3))
* populate item_libraries for unchanged items during sync (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([4125422](https://github.com/v3DJG6GL/streamystats/commit/4125422cc5377300bbaf6157b64656541c07639a))
* poster lqip loading ([aec5c25](https://github.com/v3DJG6GL/streamystats/commit/aec5c25867ba3fb543f8d0788b9c976bf5c3180a))
* prevent duplicate sessions and detect item/position changes in session poller ([fe26095](https://github.com/v3DJG6GL/streamystats/commit/fe260952d6a417375cb0ab9c345f69f8e184002d))
* prevent iOS zoom on command input ([a463cbe](https://github.com/v3DJG6GL/streamystats/commit/a463cbed7440ea1b429d823829f89c6cf09a0245))
* prevent memory leak in rate-limit maps with periodic cleanup ([6d79159](https://github.com/v3DJG6GL/streamystats/commit/6d79159364cfd7e891ef554e3db940b91643db3a))
* rate-limit QuickConnect login completion ([06ef2f5](https://github.com/v3DJG6GL/streamystats/commit/06ef2f56978d9c49a077d84d7ca6d2f7e49189d2))
* rate-limit QuickConnect status polling endpoint per IP ([5b444c4](https://github.com/v3DJG6GL/streamystats/commit/5b444c4f5d5dd57038af1fe74e6bb19875851bba))
* reduce QuickConnect polling interval from 3s to 5s ([c8127e1](https://github.com/v3DJG6GL/streamystats/commit/c8127e18f391698bff1d9f77f1c0386f63aa48ad))
* reduce sync frequency and fix repeated item updates ([eb7b9bb](https://github.com/v3DJG6GL/streamystats/commit/eb7b9bb268e12fa11437e5a13b8440b2434f8650))
* remove console.error from password-login toggle action ([cdebce0](https://github.com/v3DJG6GL/streamystats/commit/cdebce00f88b839e2c32cd47c1458cb2752018bb))
* remove Jellyfin status codes from QuickConnect error responses ([9a2a090](https://github.com/v3DJG6GL/streamystats/commit/9a2a090b4139fa9714ed29409331580c859ed07d))
* remove old cursor files ([bcf5644](https://github.com/v3DJG6GL/streamystats/commit/bcf5644b9dbecdf46748867fbf0fccf2600701e9))
* remove stale libraries during sync ([#417](https://github.com/v3DJG6GL/streamystats/issues/417)) ([57d15fa](https://github.com/v3DJG6GL/streamystats/commit/57d15fa8e66e9ed85181ca8c6f6489dcdf3873d5))
* rename database fields in job status endpoint ([cd543a2](https://github.com/v3DJG6GL/streamystats/commit/cd543a22f4b5fcc73545c2c79fb2124446e07d18))
* restore accidentally deleted database dist build artifacts ([49e2192](https://github.com/v3DJG6GL/streamystats/commit/49e2192c44c7e584651e4254fe04d4ef80622203))
* restore disablePasswordLogin UI logic lost during quickconnect-auth merge ([578bb69](https://github.com/v3DJG6GL/streamystats/commit/578bb69fbc7839eab684877538bd5e0caf3317ba))
* restore pause/resume session logging ([ba03d9e](https://github.com/v3DJG6GL/streamystats/commit/ba03d9e2ec63ea9f773bcb5fbce7c3572a27ea09))
* revert release action ([eb705d9](https://github.com/v3DJG6GL/streamystats/commit/eb705d9e26f8b4e4e9da529e65553242b2a1095a))
* scope people sync queries to server ID ([e7fabc4](https://github.com/v3DJG6GL/streamystats/commit/e7fabc42072bb1ab2b60a73fb4a8f8f08fb1dc6d))
* **search:** prioritize series/movies over episodes in search results ([#439](https://github.com/v3DJG6GL/streamystats/issues/439)) ([98e1571](https://github.com/v3DJG6GL/streamystats/commit/98e1571edff441540b79cd0bff8e0595e09767e0))
* send quick-connect secret in POST body instead of URL ([5c29e13](https://github.com/v3DJG6GL/streamystats/commit/5c29e133bc695c43ac0ae05bc09fa3c367df41e9))
* separate rate-limit counters for QC init and completion ([0d34bfd](https://github.com/v3DJG6GL/streamystats/commit/0d34bfdd3575285b3e949c9fc064b63aa3ae8a5d))
* settings menu in sidebar collapsed mode ([12a85a2](https://github.com/v3DJG6GL/streamystats/commit/12a85a2636fcbd3df64486e6084dae4640e8b14c))
* show warning on consecutive QuickConnect polling failures ([dc67e16](https://github.com/v3DJG6GL/streamystats/commit/dc67e16ac480414f12301d9a8676d00ecc5ace09))
* smaller image ([aac92dd](https://github.com/v3DJG6GL/streamystats/commit/aac92dd65f9903d0edea279539bb93eb0b3422a0))
* stale job status improvement ([51eae7e](https://github.com/v3DJG6GL/streamystats/commit/51eae7e27afb24599004fcadc1277644a447f3b1))
* status types and docs ([ac190d8](https://github.com/v3DJG6GL/streamystats/commit/ac190d8f9524301f99be2380a990dbe58012bf16))
* stop showing update notifications for latest Docker builds ([#416](https://github.com/v3DJG6GL/streamystats/issues/416)) ([dc75b07](https://github.com/v3DJG6GL/streamystats/commit/dc75b0735cd7ebea2597cef255fbd8e2f39f91b5))
* strip trailing slashes from AI base URLs ([95cf000](https://github.com/v3DJG6GL/streamystats/commit/95cf000488ef95677d89fd5da7026d86cee6574c)), closes [#324](https://github.com/v3DJG6GL/streamystats/issues/324)
* surface rate-limit error message to QuickConnect UI in production ([0e76a2f](https://github.com/v3DJG6GL/streamystats/commit/0e76a2f8af4f857e0b5ed8797795b2ce2a897902))
* unwrap nested errors in formatError function for improved error handling ([116af7a](https://github.com/v3DJG6GL/streamystats/commit/116af7a52c84838b002e62b9225e49028aa215d0))
* update Dockerfile to use Debian base image and install dependencies with apt-get ([4b11388](https://github.com/v3DJG6GL/streamystats/commit/4b11388602cc52ced0e0f2fdae252fecc18a7947))
* update healthcheck to use 127.0.0.1 and remove redundant checks from docker-compose ([fd57920](https://github.com/v3DJG6GL/streamystats/commit/fd5792006cb7f5f033383d3871055b3ce4331ae1))
* update job status endpoint to include 'queue' in the URL path ([f1d4a04](https://github.com/v3DJG6GL/streamystats/commit/f1d4a04006d88cb3fdf78ae9102eac08767f537c))
* update quick-connect client to use POST status endpoint ([1db94b0](https://github.com/v3DJG6GL/streamystats/commit/1db94b0b7adddd1cd1206a280d0464b0ad8e2b7e))
* update supervisord configuration to include environment variables for database connections ([d8fcfd0](https://github.com/v3DJG6GL/streamystats/commit/d8fcfd00efefe0a7f42050576fe5984d7cc3f9dd))
* update VSCode settings to use explicit formatting and import organization actions ([24a95d5](https://github.com/v3DJG6GL/streamystats/commit/24a95d5e8b0259ef6b3b7172f12fc5ff09f23dd3))
* use chat for queries ([28c8556](https://github.com/v3DJG6GL/streamystats/commit/28c855605507562975af4913f0beb9849b1056ee))
* use external URL for images in client components to resolve private IP blocking ([6def0a1](https://github.com/v3DJG6GL/streamystats/commit/6def0a1ecaf0f31a45debdc34d0035454c2424bb))
* use external URL in Poster component to resolve private IP image loading ([#436](https://github.com/v3DJG6GL/streamystats/issues/436)) ([51df889](https://github.com/v3DJG6GL/streamystats/commit/51df88979ba996933134af74fb2461660ac55ab5))
* use float encoding for embeddings to avoid base64 dimension issues ([53b185d](https://github.com/v3DJG6GL/streamystats/commit/53b185d1f1a305a83638b74896fd1f5115dfafcf))
* use float encoding for embeddings to avoid base64 dimension issues ([f6cffc2](https://github.com/v3DJG6GL/streamystats/commit/f6cffc21c0119d63f982b487893aaaa0adad0bd6))
* use FormattedDate in ActivityLogTable to fix hydration ([732fe37](https://github.com/v3DJG6GL/streamystats/commit/732fe376a78ca8328b571b53b22aec475da20a33))
* use getServer instead of getServerWithSecrets for login page client props ([5455dbc](https://github.com/v3DJG6GL/streamystats/commit/5455dbc2948be4bb970c42a68a63f6e7fd71e755))
* use getServer instead of getServerWithSecrets in QuickConnect status route ([08647bd](https://github.com/v3DJG6GL/streamystats/commit/08647bd88f185bbe7f4f8821dfc624040f7d14d2))
* use junction table for library exclusions to handle multi-library items (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([af5a8e4](https://github.com/v3DJG6GL/streamystats/commit/af5a8e4f091903391a9d22c40a4b5fc2ebc6c0b4))
* use junction table for library exclusions to handle multi-library items (Issue [#407](https://github.com/v3DJG6GL/streamystats/issues/407)) ([b4bc06c](https://github.com/v3DJG6GL/streamystats/commit/b4bc06c371418820d1051490a457ba8635e94acc))
* use next/navigation internal state instead ([8c3e5da](https://github.com/v3DJG6GL/streamystats/commit/8c3e5da126e0e7cbe8c478a47911bfb0ae400e9a))
* use shared rate-limiter and add Retry-After header to QC poll ([ca2f1f7](https://github.com/v3DJG6GL/streamystats/commit/ca2f1f7b64269c0f82678181e8498ed3e01e6e3e))
* use shared rate-limiter and drop getServerWithSecrets from QC functions ([1cf0ed0](https://github.com/v3DJG6GL/streamystats/commit/1cf0ed0bca657d0234ba929c69e837aacab4ba3b))
* use SQL[] universally and remove any restore Server ([4bdf766](https://github.com/v3DJG6GL/streamystats/commit/4bdf766415b78be0c048286f7621e688b7304281))
* validate QuickConnect secret format before forwarding to Jellyfin ([921d870](https://github.com/v3DJG6GL/streamystats/commit/921d870a2c5cd477c1ffbd969db584c67ff27bc0))
* version badge zindex issue ([bbe6a22](https://github.com/v3DJG6GL/streamystats/commit/bbe6a227085435266780353892e2ad854de2f2fb))
* warn admin when disabling password login without QuickConnect ([e176f9a](https://github.com/v3DJG6GL/streamystats/commit/e176f9a6c9183f41c3011ef236a13f6b8a25b42b))
* wrong db queries $1 ([200c1ed](https://github.com/v3DJG6GL/streamystats/commit/200c1edfd917cb4049bf318f9ce55d813ea9c74f))
* wrong url for mark watched ([b35043a](https://github.com/v3DJG6GL/streamystats/commit/b35043aee52af90e8e10bc24e1a167bc24e7d438))
* wrong video type in sections ([ea25a97](https://github.com/v3DJG6GL/streamystats/commit/ea25a970bd1ee129bde3f36f70174accc656d694))
